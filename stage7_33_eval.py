...
def eval_200():
    print("========================================")
    print("QUANTITATIVE EVALUATION: stage7_single_drone_200_global_fire_reward.pth")
    print("========================================")
    
    env = WildfireEnv()
    device = torch.device("cpu")
    policy = SeparateActorCritic(device=device, drone_type="WATER")
    checkpoint = torch.load("stage7_single_drone_200_global_fire_reward.pth", map_location=device, weights_only=True)
